...
/**
 * Controller CRUD danh mục quyền (Permission).
 * Toàn bộ endpoint yêu cầu quyền {@code sys:permission:manage}.
 */
@RestController
...
public class PermissionController {
    ...
    /** Cập nhật quyền (name/module/description/status — code không thể thay đổi). */
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('sys:permission:manage')")
    ...
    /** Xoá quyền khỏi danh mục (từ chối nếu vẫn còn gắn với vai trò). */
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('sys:permission:manage')")
