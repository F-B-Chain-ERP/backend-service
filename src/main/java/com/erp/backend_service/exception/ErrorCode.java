...
public enum ErrorCode {
    ...
    MENU_400_CATEGORY_IN_USE(400, "MENU_400_CATEGORY_IN_USE", "Danh mục đang được sử dụng và không thể thay đổi. Vui lòng chuyển sang INACTIVE."),
    ...
    INV_400_TRANSFER_CANCEL_REASON_REQUIRED(400, "INV_400_TRANSFER_CANCEL_REASON_REQUIRED", "Vui lòng nhập lý do hủy khi phiếu chuyển kho đang đi đường."),
    INV_400_WAREHOUSE_COUNTING(400, "INV_400_WAREHOUSE_COUNTING", "Kho đang kiểm kê, không thể nhập/xuất/chuyển kho lúc này."),
    INV_400_COUNT_HAS_OPEN_TRANSFER(400, "INV_400_COUNT_HAS_OPEN_TRANSFER", "Kho còn phiếu chuyển đang đi đường, vui lòng nhận đủ hoặc hủy trước khi chốt kiểm kê."),
    INV_400_SYSTEM_VOUCHER_ONLY(400, "INV_400_SYSTEM_VOUCHER_ONLY", "Chứng từ nguồn này do hệ thống tự sinh, không được tạo tay."),
