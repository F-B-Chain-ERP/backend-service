...
public enum ErrorCode {
    ...
    INV_400_WAREHOUSE_CODE_EXISTED(400, "INV_400_WAREHOUSE_CODE_EXISTED", "Mã kho đã tồn tại."),
    INV_400_INVALID_WAREHOUSE_TYPE(400, "INV_400_INVALID_WAREHOUSE_TYPE", "Loại kho phải là CENTRAL hoặc BRANCH."),
    INV_400_INVALID_WAREHOUSE_BRANCH(400, "INV_400_INVALID_WAREHOUSE_BRANCH", "Quan hệ loại kho - chi nhánh không hợp lệ."),
    ...
    INV_400_WAREHOUSE_IN_USE(400, "INV_400_WAREHOUSE_IN_USE", "Kho đã phát sinh dữ liệu và không thể xóa. Vui lòng chuyển sang INACTIVE."),
