...
--changeset erp:004-permission-seed
-- Reset permission data: xoa sach role_permission & permission, sau do seed 199 quyen moi
-- va gan toan bo 199 quyen cho role ADMIN (full access) de he thong hoat dong binh thuong.
...
-- Role ADMIN duoc tao san boi changeset 002 (code = 'ADMIN').
